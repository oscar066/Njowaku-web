...
export function OurStory() {
  return (
    <section className="mb-4">
      <h2 className="text-3xl font-bold mb-4 text-secondary-dark font-serif">
        Our Story
      </h2>
      <div className="grid md:grid-cols-2 gap-8 items-center">
        <div>
          <p className="text-lg mb-4 leading-relaxed text-gray-700">
            Founded in 2010, Njowaku has been transforming outdoor spaces into
          ...
          <p className="text-lg mb-4 leading-relaxed text-gray-700">
            Today, we&apos;re proud to have completed over 500 projects across
            the region, earning numerous awards for our sustainable design
            practices and client satisfaction. Our team has grown to include
            certified horticulturists, landscape architects, and maintenance
            specialists who share our vision for creating harmony between nature
            and urban spaces.
          </p>
        </div>
        <Image
